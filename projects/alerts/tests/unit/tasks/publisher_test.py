...
class TestPublisher(unittest.TestCase):
    ...
    def test_send_alert(self, mock_send_fcm_alert, mock_get_user_device):
        mock_db = MagicMock()
        ...
        Publisher.send_alert(mock_db, "user_id", "priority", "title", "message")
    ...
    def test_send_alert_user_device_not_found(self, mock_print, mock_get_user_device):
        mock_db = MagicMock()
