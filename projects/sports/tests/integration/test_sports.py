...
from projects.sports.app.main import app
from projects.sports.app.models.model import Sport
from projects.sports.app.config.db import SessionLocal
...
class TestSports:
    ...
    def seed_sports(self):
        self.sports = [
            Sport(sport_id=uuid.uuid4(), name='Football'),
            Sport(sport_id=uuid.uuid4(), name='Basketball')
        ]
        db = SessionLocal()
