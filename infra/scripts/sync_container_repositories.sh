...
ALLOWED_FOLDERS=("users" "users-auth" "sports" "sport-sessions" "authorizer" "business-partners" "miso-stripe" "training-plans" "sport-events" "alerts" "nutritional-plans" "adverse-incidents" "adverse-incidents-provider")
