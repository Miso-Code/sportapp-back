...
module "business-partners-tg" {
  ...
  target_group_name              = "business-partners-tg"
...
module "business-partners-task-def" {
  ...
  service_name          = "business-partners"
  container_image       = "887664210442.dkr.ecr.us-east-1.amazonaws.com/business-partners:latest"
  container_port        = 8000
  cpu                   = 256
  memory                = 512
...
module "business-partners-service" {
  ...
  service_name        = "business-partners-service"
  desired_count       = 1
  container_port      = 8000
