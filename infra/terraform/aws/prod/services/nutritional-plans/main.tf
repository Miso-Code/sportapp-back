...
module "nutritional-plans-tg" {
  ...
  target_group_name              = "nutritional-plans-tg"
...
module "nutritional-plans-task-def" {
  ...
  service_name          = "nutritional-plans"
  container_image       = "887664210442.dkr.ecr.us-east-1.amazonaws.com/nutritional-plans:latest"
  container_port        = 8000
  cpu                   = 256
  memory                = 512
...
module "nutritional-plans-service" {
  ...
  service_name        = "nutritional-plans-service"
  desired_count       = 1
  container_port      = 8000
