...
module "sport-sessions-tg" {
  ...
  target_group_name              = "sport-sessions-dev-tg"
...
module "sport-sessions-task-def" {
  ...
  service_name          = "sport-sessions-dev"
  container_image       = "887664210442.dkr.ecr.us-east-1.amazonaws.com/sport-sessions:develop"
  container_port        = 8000
  cpu                   = 256
  memory                = 512
...
module "sport-sessions-service" {
  ...
  service_name        = "sport-sessions-dev-service"
  desired_count       = 1
  container_port      = 8000
